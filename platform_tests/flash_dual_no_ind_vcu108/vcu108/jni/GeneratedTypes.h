...
typedef struct {
    PORTAL_DISCONNECT disconnect;
    int (*readPage) (  struct PortalInternal *p, const uint32_t card, const uint32_t bus, const uint32_t chip, const uint32_t block, const uint32_t page, const uint32_t tag );
    int (*writePage) (  struct PortalInternal *p, const uint32_t card, const uint32_t bus, const uint32_t chip, const uint32_t block, const uint32_t page, const uint32_t tag );
    int (*eraseBlock) (  struct PortalInternal *p, const uint32_t card, const uint32_t bus, const uint32_t chip, const uint32_t block, const uint32_t tag );
    ...
    int (*debugDumpReq) (  struct PortalInternal *p, const uint32_t card );
...
typedef struct {
    PORTAL_DISCONNECT disconnect;
    int (*readDone) (  struct PortalInternal *p, const uint32_t tag, const uint64_t cycles );
    int (*writeDone) (  struct PortalInternal *p, const uint32_t tag, const uint64_t cycles );
    int (*eraseDone) (  struct PortalInternal *p, const uint32_t tag, const uint32_t status, const uint64_t cycles );
    int (*debugDumpResp) (  struct PortalInternal *p, const uint32_t card, const uint32_t debug0, const uint32_t debug1, const uint32_t debug2, const uint32_t debug3, const uint32_t debug4, const uint32_t debug5 );
} FlashIndicationCb;

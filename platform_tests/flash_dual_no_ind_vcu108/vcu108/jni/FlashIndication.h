...
public:
    ...
    int readDone ( const uint32_t tag, const uint64_t cycles ) { return cb->readDone (&pint, tag, cycles); };
    int writeDone ( const uint32_t tag, const uint64_t cycles ) { return cb->writeDone (&pint, tag, cycles); };
    int eraseDone ( const uint32_t tag, const uint32_t status, const uint64_t cycles ) { return cb->eraseDone (&pint, tag, status, cycles); };
    int debugDumpResp ( const uint32_t card, const uint32_t debug0, const uint32_t debug1, const uint32_t debug2, const uint32_t debug3, const uint32_t debug4, const uint32_t debug5 ) { return cb->debugDumpResp (&pint, card, debug0, debug1, debug2, debug3, debug4, debug5); };
};
...
public:
    ...
    virtual void readDone ( const uint32_t tag, const uint64_t cycles ) = 0;
    virtual void writeDone ( const uint32_t tag, const uint64_t cycles ) = 0;
    virtual void eraseDone ( const uint32_t tag, const uint32_t status, const uint64_t cycles ) = 0;
    virtual void debugDumpResp ( const uint32_t card, const uint32_t debug0, const uint32_t debug1, const uint32_t debug2, const uint32_t debug3, const uint32_t debug4, const uint32_t debug5 ) = 0;
};
